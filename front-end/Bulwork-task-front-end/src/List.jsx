...
const List = () => {
  ...
  const [filteredCurrencies, setFilteredCurrencies] = useState(globalCurrencies);
    ...
    <div className=" mx-auto my-5 max-md:w-[80%] w-[40%] mt-10 max-h-[80%]">
      {loading ? (
        ...
        <div className="flex flex-col justify-center">
          <div className="bg-white shadow-sm rounded-md mx-auto px-6 py-2 my-2"><NavLink to={'/'}>Converter</NavLink></div>
