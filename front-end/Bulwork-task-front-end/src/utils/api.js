...
export const getCurrencies = ({setLoading, amount, filteredCurrencies, setCurrencies,setAllCurrencies}) => {
  setLoading(true);
    fetch(
...
export const getIputCurrencies = ({setLoading, newAmount, code, filteredCurrencies, setCurrencies,setAllCurrencies}) => {
  setLoading(true);
    fetch(
